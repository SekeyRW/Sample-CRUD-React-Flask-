    ...
    <footer className="text-center py-4 mt-2">
            <div className="container">
                <div className="row row-cols-1 row-cols-lg-3">
                    <div className="col">
                        <p className="text-muted my-2">Copyright&nbsp;© {new Date().getFullYear()} SAMPLE CRUD</p>
                    </div>
                    <div className="col">
                    ...
                    <div className="col">
                        <ul className="list-inline my-2">
                            <li className="list-inline-item"><a className="link-secondary" href="frontend/src/components/clientPages#">Privacy Policy</a>
                            </li>
                            <li className="list-inline-item"><a className="link-secondary" href="frontend/src/components/clientPages#">Terms of Use</a>
                            </li>
                        </ul>
                    </div>
                </div>
